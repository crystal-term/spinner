...
spawn { 20.times { sleep(0.2.seconds); sp1.spin }; ch.send(sp1.success) }
spawn { 40.times { sleep(0.2.seconds); sp2.spin }; ch.send(sp2.success) }
spawn { 80.times { sleep(0.2.seconds); sp3.spin }; ch.send(sp3.error) }
